...
def val_df_add_gas_standard_tag_column(super_big_val_df):
    ...
    json_file = open(PROJECT_ROOT + '/config/gas_standard_tag_ranges.json','r',encoding='utf-8')
...
def add_final_summary_rows_v2(super_big_val_df):
    ...
    PROJECT_ROOT = os.path.dirname(os.path.abspath(__file__))
    json_file = open(PROJECT_ROOT + '/config/summary_gas_standard_tag_ranges.json','r',encoding='utf-8')
...
def val_update_missing_v1_8(config_stuff,sn):
    ...
    if ( sn in list_of_applicable_sn ):
        ...
        PROJECT_ROOT = os.path.dirname(os.path.abspath(__file__))
        json_file = open(PROJECT_ROOT + '/config/missing_from_Saildrone_v1_8.json','r',encoding='utf-8')
