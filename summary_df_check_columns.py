...
df_10XX = pd.read_csv('./data/1004/20210512/Report_Summary_parsed_from_every_txt_file_1004.csv')
df_Saildrone = pd.read_csv('./data/3CA8A2533/Report_Summary_parsed_from_every_txt_file_3CA8A2533.csv')
